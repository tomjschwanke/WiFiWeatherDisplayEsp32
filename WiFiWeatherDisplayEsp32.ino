...
void displayAnimation(int code) {
  ...
  switch (code) {
    ...
    case 801:
      ...
      break;
    case 802:
      // display scattered clouds
      cloudDriver(scatteredClouds);
      break;
    case 803:
    case 804:
      // display overcast or broken clouds
    ...
    case 620:
    case 621:
      // Added for light to normal snowfall
      for (unsigned int i = 0; i < 5; i++) {
